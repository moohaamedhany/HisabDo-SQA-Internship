...
|---|---|---|
| Day 1 | SQA Fundamentals | Notes & Tasks |
| Day 2 | Manual Testing | Test Cases |
| Day 3 | Bug Reporting | Bug Reports |
| Day 4 | API Testing | Postman Collections |
| Day 5 | API Testing | API Test Cases |
| Day 6 | Test Documentation | Test Cases |
| Day 7 | Practice | Testing Tasks |
